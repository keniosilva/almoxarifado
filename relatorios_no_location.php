...
try {
    $stmt = $pdo->query("SELECT s.id, s.quantidade, s.data_saida, i.codigo, i.descricao 
                         FROM saidas s 
...
if (isset($_GET['gerar_pdf'])) {
    $html = '
    <h2>Relatório de Saídas de Material</h2>
...
<body>
    ...
    <div class="container mt-5">
        ...
        <div class="card shadow-sm mb-4">
            <div class="card-body">
                <a href="?gerar_pdf=1" class="btn btn-primary"><i class="fas fa-file-pdf me-2"></i>Gerar PDF</a>
            </div>
        </div>
